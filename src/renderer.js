...
const { createWindow, updateGlobalShortcuts } = require('./utils/window.js');
const { setupGeminiIpcHandlers, stopMacOSAudioCapture, sendToRenderer } = require('./utils/gemini.js');
const { initializeRandomProcessNames } = require('./utils/processRandomizer.js');
const { applyAntiAnalysisMeasures } = require('./utils/stealthFeatures.js');
const { getLocalConfig, writeConfig } = require('./config.js');
